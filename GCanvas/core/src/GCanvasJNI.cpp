...
JNIEXPORT void JNICALL Java_com_taobao_gcanvas_GCanvasJNI_setBackgroundColor(
        JNIEnv *je, jclass jc, jstring contextId, jint red, jint green, jint blue) {
    GCanvasManager *theManager = GCanvasManager::GetManager();
    char *cid = jstringToString(je, contextId);
    string canvasId = cid;
    free(cid);
    GCanvas *theCanvas = theManager->GetCanvas(canvasId);
    if (theCanvas) {
        LOG_D("Canvas JNI::setBackgroundColor.");
...
JNIEXPORT void JNICALL Java_com_taobao_gcanvas_GCanvasJNI_setHiQuality(
    ...
    GCanvas *theCanvas = theManager->GetCanvas(canvasId);
    if (theCanvas) {
        theCanvas->SetHiQuality(isHiQuality);
    }
}
...
JNIEXPORT jint JNICALL Java_com_taobao_gcanvas_GCanvasJNI_getNativeFps(JNIEnv *je, jclass jc, jstring contextId){
    ...
    GCanvasManager *theManager = GCanvasManager::GetManager();
    GCanvas *theCanvas = theManager->GetCanvas(cxx_string);
    if (theCanvas) {
